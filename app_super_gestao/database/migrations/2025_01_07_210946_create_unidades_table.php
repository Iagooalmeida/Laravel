...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        Schema::table('produto_detalhes', function (Blueprint $table) {
            $table->dropForeign('produto_detalhes_unidade_id_foreign'); // nome da tabela_nome da coluna_foreign
            $table->dropColumn('unidade_id');
        });

        // Remove o relacionamento com a tabela produtos
        Schema::table('produtos', function (Blueprint $table) {
            $table->dropForeign('produtos_unidade_id_foreign'); // nome da tabela_nome da coluna_foreign1
            $table->dropColumn('unidade_id');
        });
